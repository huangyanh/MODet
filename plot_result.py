...
plt.subplot(2, 2, 1)
for i in names:
    data = pd.read_csv(f'runs/obb/train28/{i}/results.csv')
...
plt.subplot(2, 2, 2)
for i in names:
    data = pd.read_csv(f'runs/obb/train19/{i}/results.csv')
...
plt.subplot(2, 2, 3)
for i in names:
    data = pd.read_csv(f'runs/obb/train20/{i}/results.csv')
...
plt.subplot(2, 2, 4)
for i in names:
    data = pd.read_csv(f'runs/obb/train21/{i}/results.csv')
...
plt.subplot(2, 3, 1)
for i in names:
    data = pd.read_csv(f'runs/obb/train22/{i}/results.csv')
...
plt.subplot(2, 3, 2)
for i in names:
    data = pd.read_csv(f'runs/obb/train23/{i}/results.csv')
...
plt.subplot(2, 3, 3)
for i in names:
    data = pd.read_csv(f'runs/obb/train24/{i}/results.csv')
...
plt.subplot(2, 3, 4)
for i in names:
    data = pd.read_csv(f'runs/obb/train25/{i}/results.csv')
...
plt.subplot(2, 3, 5)
for i in names:
    data = pd.read_csv(f'runs/obb/train26/{i}/results.csv')
...
plt.subplot(2, 3, 6)
for i in names:
    data = pd.read_csv(f'runs/obb/train27/{i}/results.csv')
